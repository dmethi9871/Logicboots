          ...
          <div className="container mx-auto px-4">
            <div className="mx-auto max-w-[800px] text-center">
              ...
              <div className="flex flex-col mb-12 items-center justify-center space-y-4 sm:flex-row sm:space-x-4 sm:space-y-0">
                <Link
                  href="/contact"
                  className="rounded-sm bg-primary px-8 py-4 text-base md:text-lg font-semibold text-white duration-300 ease-in-out hover:bg-primary/80"
                >
                  Contact Us
                </Link>
                <Link
                  href="mailto:info@logicboots.com"
                  className="inline-block rounded-sm bg-black px-8 py-4 text-base md:text-lg font-semibold text-white duration-300 ease-in-out hover:bg-black/90 dark:bg-white/10 dark:text-white dark:hover:bg-white/5 mt-4 md:mt-0"
                >
                  Email Us
                </Link>
              </div>
